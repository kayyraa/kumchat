...
const FetchDMs = async () => {
    ...
    Documents.forEach(async (Document) => {
        ...
        Node.addEventListener("click", function() {
            globalThis.ActiveDm = [this, Document.id];
            if (Selecting) return;
            SwitchFrame("Chat");
                    ...
                    MessageNode.ClickAndHold((Event) => {
                            ...
                            Documents.forEach(async Document => {
                                ...
                                Node.addEventListener("click", async () => {
                                    ...
                                    const NewMessage = {
                                        ...
                                        Reactions: [],
                                        Forwarded: [true, ActiveDm[0].querySelector("div").querySelector("span:nth-child(1)").textContent],
                                    };

                                    await new FireStorage("DMs").UpdateDocument(ActiveDm[1], {
                        ...
                        Array.from(Dropdown.querySelector(".ReactButton").querySelector("div").children).forEach(Reaction => {
                            ...
                            const SetReactionState = () => {
                                ...
                                const UserReacted = ReactedMessage.Reactions.some(ReactionObject => ReactionObject.User === User.Username && ReactionObject.Reaction === ReactionName);
